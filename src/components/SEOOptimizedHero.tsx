      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 relative z-10 py-8 mt-16 sm:mt-12 md:mt-8">
        <div className="max-w-5xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col items-center justify-center gap-1.5 sm:gap-2 md:gap-4 mb-4 sm:mb-6 md:mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2 md:gap-4 w-full">
              <div className="flex items-center px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 rounded-full bg-primary/20 text-primary text-xs sm:text-sm font-bold">
                <Shield className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                Gecertificeerd BRL 2810
              </div>
              <div className="flex items-center px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 rounded-full bg-yellow-500/20 text-yellow-300 text-xs sm:text-sm font-bold">
                <Star className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                4.9/5 Klantbeoordeling
              </div>
            </div>
            <div className="flex items-center px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 rounded-full bg-green-500/20 text-green-300 text-xs sm:text-sm font-bold">
          ...
          <h2 className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 mb-4 sm:mb-6 md:mb-8 leading-relaxed max-w-4xl mx-auto animate-fade-in font-semibold px-1 sm:px-2" style={{ animationDelay: '0.2s' }}>
            SMB Geveltechniek - 25+ jaar ervaring in gevelrenovatie, metselwerk, scheurherstel en renovatieankers
          </h2>

          {/* Key Services */}
          <div className="flex flex-wrap justify-center gap-1 sm:gap-2 md:gap-3 mb-6 sm:mb-8 md:mb-10 animate-fade-in px-1 sm:px-2" style={{ animationDelay: '0.3s' }}>
            {[
              "Gevelrenovatie", 
              "Metselwerk", 
              "Scheurherstel", 
              ...
              <span key={index} className="px-2 py-0.5 sm:px-3 sm:py-1 md:px-4 md:py-2 bg-white/10 backdrop-blur-sm rounded-full text-xs sm:text-sm font-medium border border-white/20">
                {service}
              </span>
            ))}
          </div>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col gap-3 sm:gap-4 md:gap-6 justify-center items-center animate-fade-in px-2 sm:px-4" style={{ animationDelay: '0.4s' }}>
          ...
          {/* Location Coverage */}
          <p className="text-xs sm:text-sm text-gray-300 mt-4 sm:mt-6 md:mt-8 animate-fade-in px-1 sm:px-2 leading-relaxed" style={{ animationDelay: '0.5s' }}>
