      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="relative mb-12 md:mb-16 lg:mb-20">
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="inline-flex items-center px-4 md:px-8 py-3 md:py-4 rounded-full bg-gradient-to-r from-primary/10 to-primary/5 text-primary text-xs md:text-sm font-bold mb-6 md:mb-8 border-2 border-primary/20 backdrop-blur-sm">
        ...
        <div className="text-center">
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-primary to-primary/90 text-white px-8 md:px-12 py-4 md:py-6 text-base md:text-xl font-bold rounded-xl md:rounded-2xl shadow-xl hover:scale-105 transition-all duration-300"
          >
