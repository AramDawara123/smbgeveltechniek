...
const AboutIntro = () => {
  const highlights = [
    { icon: Building2, title: "Opgericht", value: "Oktober 2018", description: "Gestart vanuit passie voor vakmanschap" },
    { icon: Award, title: "Ervaring", value: "25+ jaar", description: "Ruime expertise in geveltechniek" },
    { icon: Users, title: "Projecten", value: "1000+", description: "Succesvol afgeronde opdrachten" },
    { icon: Zap, title: "Innovatie", value: "Toekomst", description: "Robotisering en moderne technieken" }
  ];
    ...
    <section className="py-24 bg-gradient-to-br from-background via-muted/20 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-primary/10 text-primary font-semibold mb-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {highlights.map((item, index) => (
            <Card 
              key={item.title}
              className="group hover:construction-shadow transition-all duration-500 hover:-translate-y-2 bg-card/50 backdrop-blur-sm border-border/50 animate-fade-in"
