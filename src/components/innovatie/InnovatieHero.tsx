    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 relative z-10 py-8 mt-20 sm:mt-16 md:mt-12">
        <div className="max-w-5xl mx-auto text-center text-white">
          ...
          <p className="text-base md:text-lg text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto animate-fade-in" style={{
            animationDelay: '0.3s'
          }}>
            Bij SMB Geveltechniek geloven we in technologie als verlengstuk van vakmanschap. 
            Van metselrobots tot slimme tools - we bouwen aan de toekomst van de bouwsector.
          </p>
        </div>
      </div>
    </section>
